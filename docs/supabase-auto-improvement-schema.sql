-- LIBscope v2 auto-improvement schema draft.
-- This file is a design draft. Create an official migration with
-- `supabase migration new auto_improvement_feedback` before applying.
